public class Main implements Runnable {
	...
	private void generateMetaTestCSV() {
		...
		String[] headers = {
				"Marca__c", "Dia__c", "MesAno__c", "Cliente__c","Industria__c",	"GMR_Obj_Mes__c",
				...
				"OL_Obj_Mes__c","OL_Real__c","OL_Porc__c","OL_Obj_Acum__c","OL_Obj_Parcial__c",
				"OL_Real_Acum__c","OL_Obj_Real_Porc__c","OL_Desvio__c","OFL_Obj_Mes__c","OFL_Real__c",
				"OFL_Porc__c","OFL_Obj_Acum__c","OFL_Obj_Parcial__c","OFL_Real_Acum__c","OFL_Obj_Real_Porc__c",
				"OFL_Desvio__c","CAT_OTC__c","CAT_Gen__c","CAT_HB__c","CAT_RX__c","CAT_Dermo__c","CAT_Nutricao__c",
		...
		for(int i = 0; i < RECORDS_QTD; i++) {
			...
			factory.addRecord(
					"SC",getRandom(100),"jun-19","A" + getRandom(1000),	"Chiesi",
					getRandom(100),	getRandom(100),	getRandom(100),	getRandom(100),
					getRandom(100),	getRandom(100),	getRandom(10),getRandom(10),
					getRandom(10),getRandom(100),getRandom(1000),getRandom(1000),
					getRandom(1000),getRandom(1000),getRandom(100),getRandom(100),
					getRandom(10),getRandom(100),getRandom(10),getRandom(10),getRandom(10),
					getRandom(1000),getRandom(100),getRandom(1000000),getRandom(100),
					getRandom(100),getRandom(10),getRandom(10),getRandom(100),getRandom(100),
					getRandom(100),getRandom(10),getRandom(10),getRandom(100),getRandom(100),
					getRandom(100),getRandom(100),getRandom(10),getRandom(10),getRandom(10),
					getRandom(10),getRandom(100),getRandom(1000), getRandom(100),getRandom(10),
					getRandom(10)
				);
